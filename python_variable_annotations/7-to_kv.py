...
calculates the square of the value, and returns a tuple of the key and the squared value.
...
def to_kv(k: str, v: Union[int, float]) -> Tuple[str, float]:
    ...
    Args:
        ...
        v (Union[int, float]): The value to be squared, which can be an integer or a float.
